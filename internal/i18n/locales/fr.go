...
func init() {
	i18n.Register("fr", i18n.Locale{
		...
		"gemini.rejet.enquete":               "l'enquête demandée est incomplète ou inconnue : renseigne \"sujet\" (pourquoi_automatisation, diagnostic_piece, diagnostic_maison, resume, energie, conseil, annuler, notifier, repas, aide, inventaire)",
		...
		"decision.faux.note":          "D'accord, je note que ce n'était pas ça.",
		"decision.faux.annuler":       " Dis « annule ça » pour tout remettre comme avant.",
		"decisions.fichier.erreur":    "⚠️ Écriture du journal des décisions impossible : %v",
		"ombre.desaccord":             "🔀 Mode ombre — désaccord sur « %s » : %s a choisi [%s], %s aurait choisi [%s]",
		"ombre.accord":                "🔀 Mode ombre : accord sur « %s »",
		"appris.apprise":              "🧠 Phrase apprise : « %s » (%d action(s))",
		"appris.oubliee":              "🧠 Phrase oubliée (signalée fausse) : « %s »",
		"appris.fichier.erreur":       "⚠️ Fichier d'apprentissage illisible ou non inscriptible : %v",
		"confirmation.notification.cible": "envoyer sur %s : « %s »",
		"notification.envoyee.cible":  "C'est envoyé sur %s.",
		"notification.libelle.tonTelephone": "ton téléphone",
		"notification.echec":          "Je n'ai pas pu envoyer la notification.",
		"notification.rien":           "Je n'ai rien à envoyer pour l'instant.",
		"notification.aucun.service":  "Je ne trouve aucune application mobile Home Assistant (service notify.mobile_app_…).",
		"notification.titre":          "Assistant",
		...
		"cuisiner.rien":           "Je ne trouve aucune recette qui utilise ces ingrédients.",
		"cuisiner.resume":         "Avec %s, tu peux faire : %s.",
		"cuisiner.tout":           "%s (tout y est)",
		"cuisiner.manque":         "%s (il manque %s)",
		"gemini.rejet.enquete.ingredients": "pour « cuisiner », renseigne \"ingredients\" (ce que l'utilisateur a, séparé par des virgules)",
		"mealie.recettes.chargees": "🍲 Recettes Mealie indexées : %d",
		"annulation.restauration":  "↩️ Annulation : %s remis à « %s »",
		"explication.rien":         "Je n'ai rien à expliquer : je n'ai pas d'échange récent avec toi.",
		"explication.repli":        "Tu avais dit « %s ». Cela a été compris par %s, avec : %s.",
		"explication.repli.sans":   "Tu avais dit « %s ». Cela a été compris par %s.",
		"explication.corriger":     "Si ce n'est pas ce que tu voulais, dis « non, pas ça » puis redis-moi ce que tu voulais.",
		"mealie.inactif":           "Mealie n'est pas configuré : renseigne MEALIE_URL pour activer le menu, les recettes et le plan de repas.",
		"mealie.planifie":          "C'est noté : %s au menu, %s.",
		"mealie.hasard.titre":      "J'ai mis « %s » au menu, %s.",
		"mealie.hasard.fait":       "J'ai choisi une recette au hasard pour %s.",
		"mealie.recette.inconnue":  "Je ne trouve aucune recette qui ressemble à « %s ».",
